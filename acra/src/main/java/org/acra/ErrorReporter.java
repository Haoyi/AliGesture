 ...
 * </p>
 * <ul>
 * <li>immediately if {@link org.acra.annotation.ReportsCrashes#mode} is set to
 ...
 * <li>when the user accepts to send it if {@link org.acra.annotation.ReportsCrashes#mode()} is set
...
public class ErrorReporter implements UncaughtExceptionHandler {
    ...
    /**
     * Contains the active {@link org.acra.sender.ReportSender}s.
     */
     ...
     * @throws IllegalStateException if {@link org.acra.ACRA#init(android.app.Application)} has not yet
     *                               been called.
     * @deprecated since 4.3.0 Use {@link ACRA#getErrorReporter()}
     * instead.
     */
    @Deprecated
     ...
     * </p>
     * <p>
     * {@link ExceptionHandlerInitializer#initializeExceptionHandler(org.acra.ErrorReporter)}
     ...
     * </p>
     * <p>
     * Example. Add to the {@link android.app.Application#onCreate()}:
     * </p>
     * <p/>
     * <pre>
    ...
    /**
     * Add a {@link org.acra.sender.ReportSender} to the list of active {@link org.acra.sender.ReportSender}s.
     *
     * @param sender The {@link org.acra.sender.ReportSender} to be added.
     */
    ...
    /**
     * Remove a specific instance of {@link org.acra.sender.ReportSender} from the list of
     * active {@link org.acra.sender.ReportSender}s.
     *
     * @param sender The {@link org.acra.sender.ReportSender} instance to be removed.
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Remove all {@link org.acra.sender.ReportSender} instances from a specific class.
     *
    ...
    /**
     * Clears the list of active {@link org.acra.sender.ReportSender}s. You should then call
     * {@link #addReportSender(org.acra.sender.ReportSender)} or ACRA will not send any report
     * anymore.
     */
    ...
    /**
     * Removes all previously set {@link org.acra.sender.ReportSender}s and set the given one as
     * the new {@link org.acra.sender.ReportSender}.
     *
